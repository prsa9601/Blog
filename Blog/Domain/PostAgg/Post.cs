...
namespace Blog.Domain.PostAgg
{
    public class Post : BaseEntity
    {
        ...
        public Post(long userId, string imageName, string metaDescription, long categoryId, string title, string slug, string description, IPostDomainService service)
        {
